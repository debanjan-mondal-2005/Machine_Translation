...
encoder_model = keras.models.load_model(str(_MODELS / "fr-enencoder.h5"))
decoder_model = keras.models.load_model(str(_MODELS / "fr-endecoder.h5"))
input_tokenizer = _safe_load(str(_MODELS / "fr-enInputTokenizer.pkl"))
output_tokenizer = _safe_load(str(_MODELS / "fr-enOutputTokenizer.pkl"))
