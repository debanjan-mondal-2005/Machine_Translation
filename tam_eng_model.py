...
encoder_model = keras.models.load_model(str(_MODELS / "ta-engencoder.h5"))
decoder_model = keras.models.load_model(str(_MODELS / "ta-engdecoder.h5"))
input_tokenizer = _safe_load(str(_MODELS / "ta-engInputTokenizer.pkl"))
output_tokenizer = _safe_load(str(_MODELS / "ta-engOutputTokenizer.pkl"))
