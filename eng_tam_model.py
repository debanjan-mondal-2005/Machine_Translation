...
encoder_model = keras.models.load_model(str(_MODELS / "eng-taencoder.h5"))
decoder_model = keras.models.load_model(str(_MODELS / "eng-tadecoder.h5"))
input_tokenizer = _safe_load(str(_MODELS / "eng-taInputTokenizer.pkl"))
output_tokenizer = _safe_load(str(_MODELS / "eng-taOutputTokenizer.pkl"))
